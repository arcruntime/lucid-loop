...
export const STORY_LINES=[
 ...
 ['aggressive','ren',"All right. Bringing the energy up."],
  ...
  const direction={
    arrival: "Excited to arrive at the club with your close friend. Finally! is delighted anticipation with a smiling, buoyant rising tone, never weary relief, sarcasm or impatience. Then warmly invite your friend closer to the dancefloor, with playful energy and natural conversational rhythm. About three to four seconds, clear words, no added words, no shouting. This is joyful before the later discovery turns shocking.",
