...
CBUFFER_START(UnityPerMaterial)
    ...
    half _UseForeheadVertexControl;
CBUFFER_END
...
struct NprAttributes
{
    ...
    float2 uv : TEXCOORD0;
    float foreheadControl : TEXCOORD1;
    half4 color : COLOR;
...
struct NprVaryings
{
    ...
    half foreheadControl : TEXCOORD4;
    half4 color : COLOR;
    UNITY_VERTEX_INPUT_INSTANCE_ID
...
NprVaryings NprVertex(NprAttributes input)
{
    ...
    output.foreheadControl = input.foreheadControl;
...
half4 NprFragment(NprVaryings input, FRONT_FACE_TYPE frontFace : FRONT_FACE_SEMANTIC) : SV_Target
{
    ...
    controls.r = lerp(controls.r, saturate(input.foreheadControl), saturate(_UseForeheadVertexControl));
