Shader "LucidLoop/Characters/Study/RenForeheadVertexControlV2"
{
    Properties
    {
        _UseForeheadVertexControl("Use sampled forehead UV1 R", Float) = 0
    ...
    SubShader
    {
        ...
        Blend One Zero
        HLSLINCLUDE
        #include "RenForeheadVertexControlV2.hlsl"
        ENDHLSL
        Pass
        {
            Name "TokonForward"
