...
[Run 34786581140](https://github.com/jethac/lucid-loop/actions/runs/34786581140) passed the complete lane at pinned tag `ios-ci-9744abc`: Xcode 16.4 / iOS SDK 18.5 built both arm64 app and UnityFramework binaries. The first attempt exposed missing Objective-C exception flags; the corrected fresh export passed. The downloaded unsigned app tarball is 51,858,969 bytes, SHA-256 `011ef28bc70f06a9c00cc406a2fefa34f98503b288fee0a69f0625c2d8a8143b`, verified against its companion checksum. Export archive SHA-256 is `dbf8f2246cdfdfe45cfd8ae3c2de4c0acd5bc2bbdeba8f37a2d0e8f049e70dc2`. Its manifest records 243 dirty Unity entries; this proves compilation of the supplied export, not a clean source reproduction. Later font changes are not included in that export.

The successful run establishes compilation/linking of the supplied generated app. It does not establish signing, installation, launch, microphone permissions, physical duplex audio/AEC, touch/keyboard layout, rendering quality or sustained iPhone performance. See [IMPLEMENTATION_VALIDATION.md](IMPLEMENTATION_VALIDATION.md), alongside the separate [native voice](IOS_NATIVE_VOICE.md) and [iOS build](IOS_BUILD.md) boundaries.
