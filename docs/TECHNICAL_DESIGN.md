...
| Pause | Reference menu: Resume, Settings, Controls, Main Menu, Quit; Esc resumes | Desktop Quit/Esc need mobile adaptation; clock effects are implemented; the complete reference Settings/Controls/Main Menu flow remains polish/build scope |
...
| UI/reference fidelity | Finish and validate the source marker states, people/object distinctions, beacon readability, pause Settings/Controls/navigation and final conversation framing |
